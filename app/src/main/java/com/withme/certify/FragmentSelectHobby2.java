...
import com.withme.R;
import com.withme.model.Hobby;
import com.withme.model.HobbyBig;
import com.withme.navigation.OnItemClick;
...
//    }//어텝터 내에서 커스텀 리스너 인터페이스 정의
    ...
    @NonNull
    @Override
    public HorizontalAdapter.HorizontalViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
    ...
    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(HorizontalAdapter.HorizontalViewHolder horizontalViewHolder, int position)
    {
...
class VerticalAdapter extends RecyclerView.Adapter<VerticalAdapter.VerticalViewHolder>{
    ...
    @NonNull
    @Override
    public VerticalAdapter.VerticalViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater
                .from(viewGroup.getContext())
    ...
    @Override
    public void onBindViewHolder(@NonNull VerticalAdapter.VerticalViewHolder verticalViewHolder, int position) {
